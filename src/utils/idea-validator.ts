...
export const categories: Category[] = [
  {
    ...
    color: "#8b5cf6", // Purple
    description:
      "Understanding your target market size, growth, and accessibility",
...
export const questions: Question[] = [
  // MARKET (4 questions)
  {
    ...
    category: "market",
    tooltip:
      "Not just demographics — their job title, daily frustrations, what tools they use, where they hang out online. Vague = dangerous.",
    weight: 3,
    yesFollowUp:
      "Specific customer knowledge is your compass. It guides every decision.",
    noFollowUp:
      "Talk to 10 potential customers this week. Specificity beats assumptions.",
  },
  {
    id: "market-2",
    ...
    category: "market",
    tooltip:
      "TAM/SAM/SOM thinking. Can you put a number on how many potential customers exist and their willingness to pay?",
    weight: 2,
    yesFollowUp:
      "Good. Make sure your SOM is big enough to build a real business.",
    noFollowUp:
      "Try bottom-up: count actual customers you could reach, multiply by realistic price.",
  },
  {
    id: "market-3",
    ...
    category: "market",
    tooltip:
      "Declining markets are graveyards for startups. You want tailwinds, not headwinds.",
    weight: 2,
    yesFollowUp:
      "Rising tides lift all boats. Growth markets forgive mistakes.",
    noFollowUp:
      "Seriously reconsider. Swimming against currents exhausts even great swimmers.",
  },
  {
    id: "market-4",
    ...
    category: "market",
    tooltip:
      'Existing audience, partnership opportunities, SEO potential, or marketing budget. "Build it and they will come" is a myth.',
    weight: 3,
    yesFollowUp:
      "Distribution advantage is often more valuable than product advantage.",
    noFollowUp:
      "This is the #1 startup killer. Solve distribution before building.",
  },
  ...
  // PROBLEM (4 questions)
  {
    ...
    category: "problem",
    tooltip:
      "Real conversations, not surveys. Did they lean in? Did they ask when they could buy? Did they offer to pay for early access?",
    weight: 3,
    yesFollowUp: "Most founders skip this. You're already ahead.",
    noFollowUp:
      "Stop everything. Talk to people first. Building without validation is gambling.",
  },
  {
    id: "problem-2",
    ...
    category: "problem",
    tooltip:
      "Look for evidence: existing solutions (even bad ones), workarounds, spreadsheets, manual processes. No existing solutions often means no real problem.",
    weight: 3,
    yesFollowUp: "Existing behavior is the strongest signal of real demand.",
    noFollowUp:
      "Be cautious. You might be creating a solution looking for a problem.",
  },
  {
    id: "problem-3",
    ...
    category: "problem",
    tooltip:
      'Not "would it be nice" — would they actually pay? Have you tested willingness to pay, not just interest?',
    weight: 3,
    yesFollowUp: "Payment intent separates tire-kickers from real customers.",
    noFollowUp:
      "Nice-to-have problems don't build businesses. Find hair-on-fire urgency.",
  },
  {
    id: "problem-4",
    ...
    category: "problem",
    tooltip:
      "SaaS thrives on recurring value. One-time problems mean one-time payments and constant customer acquisition.",
    weight: 2,
    yesFollowUp: "Recurring problems = recurring revenue. The SaaS dream.",
    noFollowUp:
      "Consider if SaaS is the right model, or if you need a different business structure.",
  },
  ...
  // SOLUTION (4 questions)
  {
    ...
    category: "solution",
    tooltip:
      '10x better on at least one dimension that matters. "Slightly better" isn\'t enough to overcome switching costs.',
    weight: 3,
    yesFollowUp:
      "Clear differentiation is your moat. Protect and communicate it.",
  ...
  },
  {
    ...
    category: "solution",
    tooltip:
      "Scope discipline. If it takes 6 months, you'll run out of runway, motivation, or both before learning anything.",
    weight: 2,
    yesFollowUp: "Speed is your competitive advantage as a small team.",
    noFollowUp:
      "Scope down ruthlessly. What's the smallest thing that delivers value?",
  },
  {
    id: "solution-3",
    ...
    category: "solution",
    tooltip:
      "Platform risk is real. API changes, policy shifts, and de-platforming have killed many startups overnight.",
    weight: 2,
    yesFollowUp: "Independence gives you control over your destiny.",
    noFollowUp:
      "Have a contingency plan. Diversify dependencies where possible.",
  },
  {
    id: "solution-4",
    ...
    category: "solution",
    tooltip:
      "Enterprise sales cycles are brutal for bootstrappers. Bottom-up adoption is faster and cheaper.",
    weight: 2,
    yesFollowUp: "Bottom-up adoption is the bootstrapper's secret weapon.",
    noFollowUp:
      "Long sales cycles drain resources. Consider if you can start smaller.",
  },
  ...
  // DISTRIBUTION (4 questions)
  {
    ...
    tooltip:
      "Newsletter, audience, partnerships, community, or meaningful marketing budget. Zero distribution = zero customers.",
    weight: 3,
    yesFollowUp:
      "Your existing reach is worth more than you think. Leverage it.",
    noFollowUp:
      "Start building distribution now. Content, community, or partnerships.",
  },
  {
    id: "distribution-2",
    ...
    category: "distribution",
    tooltip:
      "SEO potential, relevant keywords with search volume, ability to rank. Search intent = high-quality leads.",
    weight: 2,
    yesFollowUp: "SEO is a compounding asset. Start content investment early.",
    noFollowUp:
      "You'll need alternative channels. Paid, social, or partnerships.",
  },
  {
    id: "distribution-3",
    ...
    category: "distribution",
    tooltip:
      "Network effects, viral loops, or strong word-of-mouth potential. Does using it make people want to share it?",
    weight: 2,
    yesFollowUp: "Organic growth is the best growth. Nurture and amplify it.",
    noFollowUp:
      "You'll rely more on paid acquisition. Make sure unit economics work.",
  },
  {
    id: "distribution-4",
    ...
    category: "distribution",
    tooltip:
      "CAC < LTV is the fundamental equation. Without it, you're subsidizing every customer.",
    weight: 3,
    yesFollowUp: "Profitable unit economics unlock sustainable growth.",
    noFollowUp:
      "This breaks businesses. Find cheaper channels or increase LTV.",
  },
  ...
  // FOUNDER FIT (4 questions)
  {
    ...
    category: "founder",
    tooltip:
      "Domain knowledge, industry connections, technical edge, or unique insight. Why are YOU the one to build this?",
    weight: 3,
  ...
  },
  {
    ...
    category: "founder",
    tooltip:
      "Startups take longer than expected. Passion for the problem (not just the solution) sustains you through hard times.",
    weight: 2,
    yesFollowUp: "Genuine passion is the ultimate competitive advantage.",
    noFollowUp:
      "Consider if this is the hill you want to climb. Commitment matters.",
  },
  {
    id: "founder-3",
    ...
    category: "founder",
    tooltip:
      "Technical founders who can ship have a massive advantage. Dependency on others slows everything down.",
    weight: 2,
    yesFollowUp: "Maker skills are superpowers. Ship fast, learn faster.",
    noFollowUp:
      "Find a technical co-founder or learn to code. This is critical.",
  },
  {
    id: "founder-4",
    ...
    category: "founder",
    tooltip:
      "Time availability, financial runway, family obligations, location requirements. Misalignment here creates unsustainable stress.",
    weight: 2,
    yesFollowUp: "Sustainable founder life = sustainable company building.",
    noFollowUp:
      "Adjust the model or your constraints. Burnout kills more startups than competition.",
  },
];
...
function getGradeAndHeadline(
  ...
  if (percentage >= 85) {
    ...
    return {
      grade: "D",
      headline:
        "Significant validation needed. Don't build yet — talk to more customers.",
    };
  }
  return {
    grade: "F",
...
function generateRecommendations(
  ...
  if (answers["problem-1"] === "no") {
    recommendations.push({
      ...
      action:
        "Schedule 5 customer conversations this week. No building until you've talked to people.",
    });
  }
  ...
  if (answers["problem-3"] === "no") {
    recommendations.push({
      ...
      action:
        "Test willingness to pay by asking for pre-orders or deposits before building.",
    });
  }

  // Critical: Distribution
  if (
    answers["distribution-1"] === "no" &&
    answers["distribution-2"] === "no"
  ) {
    recommendations.push({
      priority: "critical",
      category: "distribution",
      ...
      action:
        "Build distribution before product. Start a newsletter, join communities, or find partners.",
    });
  }
  ...
  if (answers["market-1"] === "no") {
    recommendations.push({
      ...
      action:
        "Create a detailed ideal customer profile. Name them. Describe their day.",
    });
  }
  ...
  if (answers["founder-1"] === "no") {
    recommendations.push({
      ...
      action:
        "Consider partnering with a domain expert or building expertise first.",
    });
  }
  ...
  if (answers["solution-2"] === "no") {
    recommendations.push({
      ...
      action:
        "Cut scope by 80%. What's the smallest version that delivers value?",
    });
  }
  ...
  if (answers["problem-4"] === "no") {
    recommendations.push({
      ...
      action:
        "Explore adjacent recurring pain points or different business models.",
    });
  }
...
function identifyStrengthsWeaknesses(
  ...
  for (const { category, score } of sortedCategories.slice(0, 2)) {
    if (score.percentage >= 60) {
      if (category.id === "market") {
        strengths.push("Strong market understanding");
      }
      if (category.id === "problem") {
        strengths.push("Well-validated problem");
      }
      if (category.id === "solution") {
        strengths.push("Compelling solution approach");
      }
      if (category.id === "distribution") {
        strengths.push("Clear path to customers");
      }
      if (category.id === "founder") {
        strengths.push("Strong founder-market fit");
      }
    }
  }
  ...
  for (const { category, score } of sortedCategories.slice(-2).reverse()) {
    if (score.percentage < 50) {
      if (category.id === "market") {
        weaknesses.push("Market definition needs work");
      }
      if (category.id === "problem") {
        weaknesses.push("Problem validation is lacking");
      }
      if (category.id === "solution") {
        weaknesses.push("Solution differentiation unclear");
      }
      if (category.id === "distribution") {
        weaknesses.push("Distribution strategy is weak");
      }
      if (category.id === "founder") {
        weaknesses.push("Founder fit concerns");
      }
    }
  }
...
export function saveProgress(
  ...
  try {
    ...
    log.warn("Could not save progress to localStorage:", e);
  }
}
...
export function loadProgress(): SavedState | null {
  try {
    ...
    log.warn("Could not load progress from localStorage:", e);
  }
  return null;
}
...
export function clearProgress(): void {
  try {
    ...
    // localStorage not available
    log.warn("Could not clear progress from localStorage:", e);
  }
}
