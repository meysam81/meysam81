...
I'm building in public. Every failure. Every lesson. Every small win.

- **Newsletter:** [meysam.io](https://meysam.io) — 1,500+ readers getting weekly lessons from the trenches
- **awesome-directories:** [awesome-directories.com](https://awesome-directories.com) — Free directory aggregator for indie hackers
- **X/Twitter:** [@meysamazing](https://x.com/meysamazing) — Daily updates on the journey

No BS. No overnight success stories. Just honest documentation of the path from SRE engineer to (hopefully) profitable founder.
