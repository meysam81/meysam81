...
> = {
  devtool: {
    ...
    subtitle: "Ship 10x faster with intelligent PR analysis and suggestions",
    category: "Developer Tool",
    features: ["Free Trial", "GitHub Integration", "Slack Alerts"],
    icon: "tool",
    theme: "blue",
    demoInput: "PR #1247",
    demoOutput: "3 issues found, 12 improvements suggested",
  },
  blog: {
    title: "Why We Migrated to Edge Computing",
    subtitle: "How we reduced latency by 73% and saved $40k monthly",
    category: "Case Study",
    features: ["8 min read", "Engineering", "Performance"],
    icon: "lightbulb",
    theme: "purple",
    demoInput: "",
    demoOutput: "",
  ...
  saas: {
    title: "DataSync Pro",
    subtitle: "Real-time data synchronization across your entire stack",
    category: "SaaS Platform",
    features: ["14-day Trial", "SOC2 Type II", "99.99% Uptime"],
    icon: "rocket",
    theme: "green",
    demoInput: "",
    demoOutput: "",
  ...
  opensource: {
    title: "NextAuth v5",
    subtitle: "Authentication for Next.js 14 with App Router support",
    category: "Open Source",
    features: ["MIT License", "TypeScript", "20+ Providers"],
    icon: "code",
    theme: "orange",
    demoInput: "",
    demoOutput: "",
  ...
  course: {
    ...
    subtitle: "Master ARR, churn, CAC, and LTV for product-led growth",
    category: "Online Course",
    features: ["6-week program", "Real examples", "Certificate"],
    icon: "chart",
    theme: "pink",
    demoInput: "",
    demoOutput: "",
...
function generateMinimalHTML(data: PreviewData, theme: ThemeColors): string {
  ...
  var categoryHTML = data.category
    ? '<div style="display:inline-block;padding:8px 20px;background:' +
      ...
      theme.secondary +
      ';font-size:14px;font-weight:600;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:24px;">' +
  ...
  return (
    ...
    '<div style="position:absolute;top:0;left:0;right:0;bottom:0;background-image:linear-gradient(' +
    theme.bgSubtle +
    " 1px,transparent 1px),linear-gradient(90deg," +
    theme.bgSubtle +
    ' 1px,transparent 1px);background-size:60px 60px;"></div>' +
    '<div style="position:absolute;left:0;top:0;width:8px;height:100%;background:' +
    theme.gradient +
    ';"></div>' +
    ...
    "</h1>" +
    '<div style="width:120px;height:4px;background:' +
    theme.gradient +
...
function generateGradientHTML(data: PreviewData, theme: ThemeColors): string {
  var iconHTML =
    data.icon !== "none" && ICONS[data.icon]
      ? '<div style="position:absolute;left:80px;top:120px;"><svg width="120" height="120" viewBox="0 0 120 120" style="color:' +
        theme.primary +
        ';">' +
        ICONS[data.icon] +
        "</svg></div>"
  ...
  var categoryHTML = data.category
    ? '<div style="display:inline-block;padding:6px 16px;background:' +
      theme.bgGlow +
      ";border:1px solid " +
      theme.borderSubtle +
      ";border-radius:20px;color:" +
      theme.secondary +
      ';font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:20px;">' +
      escapeHtml(data.category) +
      "</div>"
    : "";
  ...
  return (
    ...
    '<div style="position:absolute;top:-150px;right:-150px;width:500px;height:500px;background:radial-gradient(circle,' +
    theme.bgGlow +
    ' 0%,transparent 70%);border-radius:50%;"></div>' +
    ...
    '<svg width="32" height="32" viewBox="0 0 200 200"><circle cx="100" cy="100" r="70" fill="none" stroke="' +
    theme.primary +
    '" stroke-width="3"/><text x="100" y="135" font-family="-apple-system,BlinkMacSystemFont,\'Segoe UI\',sans-serif" font-size="110" font-weight="700" fill="' +
    theme.primary +
    '" text-anchor="middle">M</text></svg>' +
    '<span style="color:#6a6a6a;">|</span><span style="font-size:18px;color:#6a6a6a;">' +
    escapeHtml(data.url) +
    "</span></div>" +
    ...
    '<span style="padding:8px 16px;border-radius:6px;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.05em;background:' +
    theme.bgGlow +
    ";border:1px solid " +
    theme.borderSubtle +
    ";color:" +
...
function generateSplitHTML(data: PreviewData, theme: ThemeColors): string {
        ...
        data.features
          ...
          .map(function (f) {
            return (
              ...
              theme.primary +
              ';font-size:12px;font-weight:bold;">&#10003;</span><span>' +
              escapeHtml(f) +
              "</span></div>"
            );
          })
  ...
  var categoryHTML = data.category
    ? '<div style="display:inline-block;padding:8px 18px;background:' +
      theme.bgSubtle +
      ";border:1px solid " +
      theme.borderSubtle +
      ";border-radius:6px;color:" +
      theme.secondary +
      ';font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.12em;margin-bottom:28px;">' +
      escapeHtml(data.category) +
      "</div>"
    : "";
  ...
  var demoCardHTML =
    data.demoInput || data.demoOutput
      ? '<div style="position:absolute;right:80px;top:100px;width:420px;height:380px;background:#1a1a1a;border:2px solid #2a2a2a;border-radius:16px;padding:32px;display:flex;flex-direction:column;">' +
        ...
        (data.demoInput
          ? '<div style="display:flex;flex-direction:column;gap:10px;"><span style="font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.1em;color:#6a6a6a;">Input</span><div style="padding:16px 20px;background:#0a0a0a;border:1px solid #2a2a2a;border-radius:10px;font-family:\'SF Mono\',Monaco,Consolas,monospace;font-size:20px;color:' +
            theme.secondary +
  ...
  return (
    "<div style=\"width:1200px;height:630px;background:#0a0a0a;position:relative;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;overflow:hidden;\">" +
    '<div style="position:absolute;top:0;left:0;right:0;bottom:0;background:linear-gradient(135deg,' +
    theme.bgSubtle +
...
async function copyVariantToClipboard(variant: string): Promise<void> {
  ...
  try {
    ...
    alert(
      "Failed to copy to clipboard. Try using the Download button instead.",
    );
  } finally {
    setTimeout(function () {
      copyingVariant.value = null;
    }, 2000);
  }
}
  ...
  <div class="social-preview-tool">
      ...
      <div class="form-grid">
        <div class="form-group full-width">
          ...
          <input
            v-model="titleInput"
            type="text"
            placeholder="e.g., AI-Powered Code Reviews"
            maxlength="60"
          />
        ...
        <div class="form-group full-width">
          ...
          <input
            ...
            type="text"
            placeholder="e.g., Ship 10x faster with intelligent PR analysis"
            maxlength="120"
          />
        ...
        <div class="form-group full-width">
          ...
          <input
            ...
            type="text"
            placeholder="e.g., Free Trial, GitHub Integration, Slack Alerts"
          />
        </div>
        <div class="form-group">
        ...
        <div class="form-group full-width">
          ...
          <div class="demo-inputs">
            <input
              v-model="demoInput"
              type="text"
              placeholder="Input: PR #1247"
              maxlength="30"
            />
            <input
              v-model="demoOutput"
              type="text"
              placeholder="Output: 3 issues found"
              maxlength="40"
            />
          </div>
        </div>
    ...
    <div class="tool-card previews-section">
      ...
      <div class="variants-grid">
        <div
          v-for="variant in ['minimal', 'gradient', 'split']"
          :key="variant"
          ...
          <div class="variant-header">
            ...
            <div class="variant-actions">
              <button
                type="button"
                class="copy-btn"
                :class="{ copied: copyingVariant === variant }"
                @click="copyVariantToClipboard(variant)"
              >
                <svg
                  v-if="copyingVariant !== variant"
                  width="18"
                  height="18"
                  viewBox="0 0 24 24"
                  fill="none"
                ...
                <span class="btn-text">{{
                  copyingVariant === variant ? "Copied!" : "Copy"
                }}</span>
              </button>
              <button
                type="button"
                class="download-btn"
                :disabled="downloadingVariant === variant"
                @click="downloadVariant(variant)"
              >
                <svg
                  v-if="downloadingVariant !== variant"
                  width="18"
                  height="18"
                  viewBox="0 0 24 24"
                  fill="none"
                ...
                <span class="btn-text">{{
                  downloadingVariant === variant ? "Generating..." : "Download"
                }}</span>
              </button>
            </div>
          </div>
    ...
    <div class="tool-card platform-section">
      ...
      <div class="platform-tabs">
        <button
          v-for="platform in ['twitter', 'linkedin', 'slack']"
          :key="platform"
          type="button"
          class="platform-tab"
      ...
      <div
        ...
        class="platform-mockup twitter-mockup"
      >
        <div class="tweet-container">
          ...
          <div class="tweet-actions">
            <span>💬 12</span><span>🔄 48</span><span>❤️ 256</span
            ><span>📊 1.2K</span>
          </div>
        </div>
      </div>
      ...
      <!-- LinkedIn Mockup -->
      <div
        v-else-if="activePlatform === 'linkedin'"
        class="platform-mockup linkedin-mockup"
      >
        <div class="linkedin-post">
          ...
          <p class="linkedin-text">
            Excited to share this tool with my network! Perfect for anyone
          ...
          <div class="linkedin-actions">
            <span>👍 128</span><span>💬 24</span><span>🔄 18</span>
          </div>
        </div>
      </div>
